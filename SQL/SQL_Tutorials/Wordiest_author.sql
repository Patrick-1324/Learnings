...
1. select all the authors who have written more than 1 million words, using GROUP BY and HAVING. 
...
-- 2.--
SELECT author, AVG(words) AS avg_words FROM books GROUP BY author HAVING avg_words > 100000;