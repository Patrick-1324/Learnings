...
2. The goal is a table that shows how many students have earned which letter_grade. 
...
-- 1.--
SELECT name, number_grade, ROUND(100 * fraction_completed) AS percentage_completed FROM student_grades;
